...
R package **mip**, version **0.148.11**
...
Klein D, Dietrich J, Baumstark L, Humpenoeder F, Stevanovic M, Wirth S, Führlich P, Richters O, Rüter T (2024). _mip: Comparison of multi-model runs_. doi: 10.5281/zenodo.1158586 (URL: https://doi.org/10.5281/zenodo.1158586), R package version 0.148.11, <URL: https://github.com/pik-piam/mip>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 0.148.11},
